class ParcelsDeliveryService:
      ...
      def add_parcels(self, parcel):
             ...
             print(f"The '{parcel}' added to be delivered")
      def processing_parcels(self):
            if self.delivery_queue:
                  parcel = self.delivery_queue.pop()            # Pop
      ...
      def undo_parcels(self):
            if self.undo_stack:
                  parcel =self.undo_stack.pop()                   # Pop
                  self.delivery_queue.append(parcel)           # Push
...
if __name__ ==  "__main__":
      ...
      services.add_parcels("Gisagara Prc ")
      services.add_parcels("Nyamagabe Prc ")
      services.add_parcels("Huye Prc ")
      services.add_parcels("Kamonyi parc ")
